...
const s_formId = '1FAIpQLSfcCJl2IqASez9qov_ejc2738cJwhxEWKoq8razbgwHFYwhYQ';
const s_nameId = '1135224256';
const s_websiteId = '262411035';
const s_textId = '670348377';
const s_moderatedId = '1157194196'; // The Moderated field ID
const s_pageId = '1280977710';
const s_replyId = '1368405261';
...
const s_textFieldLabel = 'Your Comment';
const s_submitButtonLabel = 'Submit';
const s_loadingText = 'Loading comments...';
const s_noCommentsText = '<div class="noComments">No comments yet!</div>';
...
`;
const v_formHtml = `
    <h4 id="c_widgetTitle">${s_widgetTitle}</h4>

    <div id="c_nameWrapper" class="c-inputWrapper">
        <input class="c-input c-nameInput" placeholder="${s_nameFieldLabel}" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>

    <div id="c_websiteWrapper" class="c-inputWrapper">
        <input class="c-input c-websiteInput" placeholder="${s_websiteFieldLabel}" name="entry.${s_websiteId}" id="entry.${s_websiteId}" type="url" pattern="https://.*">
    </div>

    <div id="c_textWrapper" class="c-inputWrapper">
        <textarea class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50"  maxlength="${s_maxLength}" required>${s_textFieldLabel}</textarea>
...
function convertTimestamp(timestamp) {
    ...
    // Use "en-GB" for DD/MM/YYYY format, when it is not assigned it uses american formate which is: MM/DD/YYYY
    return [offsetDate.toLocaleString("en-GB"), offsetDate.toLocaleDateString("en-GB")];
}
// DST checker
function isDST(date) {
